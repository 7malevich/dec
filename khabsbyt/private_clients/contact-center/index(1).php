...
<div class="mycont">
	<input type="submit" class="btn btn-success mybutt left0" value="Позвонить" onclick="InfinityCall({ host: 'webinf.dvec.ru', port: 5002, secure: true, from: '80000009003', timeout: 15000, onFinished: function () { alert('Звонок завершен.'); } });">
