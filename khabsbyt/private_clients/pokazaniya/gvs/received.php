...
if (($_COOKIE['dvec_meter_mpi_gvs']) and (intval($_COOKIE['dvec_meter_mpi_gvs']) < 91) and ($_COOKIE['dvec_pokazaniya_gvs'] == 'khabsbyt'))
...
<!-- <div class="row" style="margin-bottom:25px">
	<div class="col-sm-6">
		<div class="card">
			<img src="/khabsbyt/private_clients/dps_voda/card_br_sch_gvs.jpg" class="card-img-top" alt="Счетчик ХВС">
			<div class="card-body">
				<p class="text-left">Хабаровскэнергосбыт предлагает услугу первичной установки счетчиков воды с регистрацией, замену счетчиков «под ключ».</p>
				<a href="/khabsbyt/private_clients/dps_voda/" class="btn btn-primary text-white">
					Оставить заявку
				</a>
			</div>
		</div>
