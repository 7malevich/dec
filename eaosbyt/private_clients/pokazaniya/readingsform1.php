...
<div id="pokazaniya_gvs" style="height: auto; width: 488px; padding: 15px 20px 7px 20px; margin: 25px auto; background-color: #f8dae6;border: 1px solid #e7b7ca;text-align:left">
	...
	<ul><li><a href="gvs/">По горячему водоснабжению</a></li>
		...
		<li><a href="teplo/"><b>По холодному водоснабжению</b></a></li></ul>
</div>

<div id="pokazaniya_gvs_hes" style="display:none; height:auto; width:530px;">
...
<div id="pokazaniya_gvs_dal" style="display:none; height:auto; width:530px;">
	<div style="padding:10px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
		<p style="font-size:16px; text-align:left"><a href="https://www.dvec.ru/press_center/news_dvec/?ID=17898"><b>Уважаемые клиенты г. Владивостока!</b><br> Показания индивидуальных приборов учета по ГВС 
			необходимо подавать в ПАО «ДЭК» и «Вычислительный центр по коммунальным платежам» (для начислений по водоотведению). Читать далее &gt;&gt;&gt;</a></p> 
	</div>  
	<iframe width="530" height="298" src="https://www.youtube.com/embed/jAnK-Dy_4oc?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe>
	<div style="padding:15px 20px 7px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
	<p style="font-size:16px; text-align:left"><b>Передавайте также показания:</b></p> 
