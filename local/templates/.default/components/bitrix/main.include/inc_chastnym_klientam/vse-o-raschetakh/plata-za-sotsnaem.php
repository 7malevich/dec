        ...
        <div class="container text-block">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">Тип жилья, для которого установлен размер платы/наименование
                            поселения
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">для жилых помещений в многоквартирных домах от 3 этажей и выше,
                            не оборудованных лифтами
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">Постановление администрации Казачинского сельсовета Казачинского
                            района
                        </p>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <p style="text-align: center;">Решение Имбежского сельского Совета депутатов Партизанского
                            района
                        </p>
                    </td>
                    <td rowspan="2">
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <p style="text-align: center;">Решение Партизанского районного Совета депутатов Партизанского
                            района
                        </p>
                    </td>
                    <td rowspan="2">
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <p style="text-align: center;">Решение Партизанского сельского Совета депутатов Партизанского
                            района
                        </p>
                    </td>
                    <td rowspan="2">
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        <p style="text-align: center;">Постановление администрации Атамановского сельсовета
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <p style="text-align: center;">Постановление администрации Кононовского сельсовета
                            Сухобузимского района
                        </p>
                    </td>
                    <td rowspan="2">
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        <p style="text-align: center;">Постановление администрации Миндерлинского сельсовета
                            Сухобузимского района
                        </p>
                    </td>
                    <td rowspan="3">
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        <p style="text-align: center;">Постановление администрации Нахвальского сельсовета
                            Сухобузимского района
                        </p>
                    </td>
                    <td rowspan="3">
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <p style="text-align: center;">Постановление администрации Подсопочного сельсовета
                            Сухобузимского района
                        </p>
                    </td>
                    <td rowspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">для жилых домов и жилых помещений в зданиях со смешанными,
                            деревянными или брусчатыми стенами, деревянными перекрытиями
                        </p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">для жилых домов и жилых помещений в зданиях с кирпичными стенами,
                            монолитного шлакобетона, легких шлакоблоков, деревянными перекрытиями
                        </p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">для жилых домов и жилых помещений в каменных зданиях, с
                            кирпичными стенами, железобетонными и бетонными перекрытиями, в зданиях с крупнопанельными
                ...
                <tr>
                    ...
                    <td>
                        <p style="text-align: center;">Решение Озероучумского сельского Совета депутатов Ужурского
                            района
                        </p>
                    </td>
                    <td>
...
<div id="bx_1949384460_1381">
    <section class="block section-pt0">
        <div class="container">

            <a href="/upload/iblock/60e/de0ex277a72g84fx0diacebbj4zpz1j4/Postanovlenie-Administracii-goroda-Lesosibirska_251059_19_12_2022_ver1_.PDF"
               class="file-download border-top-bottom" target="_blank" id="bx_3218110189_1382">
                <div class="h6">
                    г. Лесосибирск. Об утверждении методики определения платы за наем муниципальных жилых помещений для
                    нанимателей муниципального жилищного фонда
                </div>
                <div class="c2">
                    PDF, 7.4 мб
                </div>
            </a>
            <a href="/upload/iblock/108/abluug51fp2w1f84igjn36nu6kyh5vcc/Postanovlenie-_-210-ot-21.10.2021.pdf"
               class="file-download border-top-bottom" target="_blank" id="bx_3218110189_1383">
                <div class="h6">
                    г. Шарыпово. Об установлении размера платы за пользование жилым помещением для нанимателей жилых
