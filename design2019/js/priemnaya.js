...
function ukazhite() { setTimeout(check_if_display_correct, 2500) }
function check_if_display_correct() { //перезагружает страницу, если был глюк и дропбокс не отобразился
  e2 = document.getElementById('form_dropdown_otdelenie');
  ...
  if (e2_display == 'none') { 
    ...
    e1 = $( '#form_dropdown_otdelenie option:contains("Укажите")' );
