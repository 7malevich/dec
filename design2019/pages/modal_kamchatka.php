  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body text-center">
        <a href="/kamchatka/private_clients/news/news.php?ID=41214"><img src="/private_clients/cabinet/privetmir_3_kvadrat2.jpg" class="m-0 p-0"></a>
      </div>
      <div class="modal-footer">
<a href="/kamchatka/private_clients/news/news.php?ID=41214" class="btn btn-primary" style="color:white">Как получать кешбэк</a>
