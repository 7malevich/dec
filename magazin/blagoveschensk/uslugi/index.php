...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		"BASKET_URL" => "/magazin/blagoveschensk/zakazy/korzina.php",
		...
		"PRICE_CODE" => array("Амурэнергосбыт"),
		"PRICE_VAT_INCLUDE" => "Y",
		...
		"SECTION_TOP_DEPTH" => "3",
		"SEF_FOLDER" => "/magazin/blagoveschensk/uslugi/",
		"SEF_MODE" => "Y",
		...
		"STORES" => array("77",""),
		"STORE_PATH" => "/magazin/blagoveschensk/sklady/?ID=#store_id#",
		"TEMPLATE_THEME" => "blue",
