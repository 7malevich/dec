...
$APPLICATION->SetTitle("Интернет-магазин: г.&nbsp;Благовещенск");
?><h2>Товары:</h2>
<div class="row">
  <div class="col-sm-6 mb-4">
    <div class="card">
      <div class="card-body text-center">
		  <img src="/magazin/files/gr_avtomaticheskie_vyklyuchateli.jpg" class="card-img-top" alt="Автоматические выключатели">
        <h4 class="card-title">Автоматические выключатели</h4>
        <a href="tovary/avtomaticheskie_vyklyuchateli/" class="btn btn-primary">Открыть</a>
      </div>
    </div>
  </div>
<!--  <div class="col-sm-6 mb-4">
    <div class="card">
      <div class="card-body text-center">
        ...
        <a href="tovary/vodoschetchiki/" class="btn btn-primary">Открыть</a>
      </div>
    </div>
  </div> -->
  <div class="col-sm-6 mb-4">
    <div class="card">
      <div class="card-body text-center">
        <img src="/magazin/files/gr_energosberegayushchie_lampy.jpg" class="card-img-top" alt="Энергосберегающие лампы">
...
<div class="row">
  <!-- <div class="col-sm-6 mb-4">
    <div class="card">
      <div class="card-body text-center">
        <img src="/magazin/files/gr_elektroschetchiki_din_reyki.jpg" class="card-img-top" alt="DIN-рейки">
        <h4 class="card-title">DIN-рейки</h4>
        <a href="tovary/elektroschetchiki/din_reyki/" class="btn btn-primary">Открыть</a>
      </div>
    </div>
  </div> -->
  <div class="col-sm-6 mb-4">
    <div class="card">
      <div class="card-body text-center">
        <img src="/magazin/files/gr_prochie_tovary.jpg" class="card-img-top" alt="Прочие товары">
...
<div class="bg-light border rounded d-flex mt-1 mb-4 px-3 py-4 justify-content-left align-items-center">
	...
	<span>Остались вопросы? Мы с удовольствием свяжемся с Вами, <br>звоните по номеру <a href="tel:+74162398115">(4162)&nbsp;398-115</a>.</span>
