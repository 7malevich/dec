...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"ADDITIONAL_PICT_PROP_257" => "-",
		"ADDITIONAL_PICT_PROP_258" => "-",
		...
		"EMPTY_BASKET_HINT_PATH" => "/magazin/petropavlovsk/",
		...
		"PATH_TO_AUTH" => "/magazin/petropavlovsk/zakazy/",
		"PATH_TO_BASKET" => "/magazin/petropavlovsk/zakazy/korzina.php",
		"PATH_TO_PAYMENT" => "oplata.php",
		"PATH_TO_PERSONAL" => "/magazin/petropavlovsk/zakazy/",
		"PAY_FROM_ACCOUNT" => "N",
