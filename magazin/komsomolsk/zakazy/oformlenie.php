...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"EMPTY_BASKET_HINT_PATH" => "/magazin/komsomolsk/",
		...
		"PATH_TO_AUTH" => "/magazin/komsomolsk/zakazy/",
		"PATH_TO_BASKET" => "/magazin/komsomolsk/korzina.php",
		"PATH_TO_PAYMENT" => "oplata.php",
		"PATH_TO_PERSONAL" => "/magazin/komsomolsk/zakazy/",
		"PAY_FROM_ACCOUNT" => "N",
