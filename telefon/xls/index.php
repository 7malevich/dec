...
<table class="table table-bordered" id="tblData">
  <tr>
    <td colspan="8">
		<span id="my_hdr">Телефонный справочник загружается...</span>
		<span id="my_btn_export"></span>
    </td>
  </tr>
  <tr>
    <th>Должность</th>
	...
	<th class="text-center">Тел.внутр.</th>
	<th class="text-center">Тел.внеш.</th>
	<th class="text-center">E-mail</th>
	<th>Адрес</th>
	<th class="text-center">Каб.</th>
  </tr>
  <tr id="org_-1_children">
  </tr>
</table>
