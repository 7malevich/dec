...
//$APPLICATION->SetTitle("ДЭК - Телефонный справочник");
//global $APPLICATION;                           
//if (CModule::IncludeModule('statistic')) { CStatEvent::AddCurrent('portal', 'telefon'); } // записываем в статистику событий битрикс
?><!DOCTYPE html>
<html lang="ru">
<head>
...
<footer class="container my-5">
  <p class="text-center">
	  <a href="mailto:pressa8@dvec.ru?subject=Телефонный справочник ДЭК">Обратная связь</a> | <a href="instrukciya/">Инструкция</a> | <a href="xls/" target="_blank">Сохранить в XLS</a>
  </p>
</footer>
