...
$to = 'orn9@nakhodka.prim.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (ЕРИЦ Находка)';
$file = $_SERVER["DOCUMENT_ROOT"]."/srv/office_zapis/des_nhk_eric/queue.txt";
$content = file($file);
