...
$to = 'cashier23@ner.amur.dvec.ru, zam1@ner.amur.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (ЕРИЦ Нерюнгри)';

$file = $_SERVER["DOCUMENT_ROOT"]."/srv/office_zapis/neru_eric/queue.txt";
$content = file($file);
