...
$to = 'pressa8@dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (тестовый офис)';

$file = $_SERVER["DOCUMENT_ROOT"]."/srv/office_zapis/test_office/queue.txt";
$content = file($file);
