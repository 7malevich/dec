...
$APPLICATION->SetTitle("Запись в офис онлайн: расписание (ЕРИЦ Владивосток)");
...
function lookToday() {
	...
	var url = '/srv/office_zapis/local_timetable.php?date1=' + date1 + '&date2=' + date2 + '&qid=des_vl_okt';
...
function lookStats() {
	...
	var url = '/srv/office_zapis/local_stats.php?date1=' + date1 + '&date2=' + date2 + '&qid=des_vl_okt';
...
function DeleteZapis2() {
	...
	var url = '/srv/office_zapis/local_delete.php?line=' + lineid + '&qid=des_vl_okt';
