...
$to = 'zapis@vrkc.prim.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (ЕРИЦ Владивосток Октябрьская 8)';

$file = $_SERVER["DOCUMENT_ROOT"]."/srv/office_zapis/des_vl_okt/queue.txt";
$content = file($file);
