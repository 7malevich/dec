...
$compress_options['password'] = "a4467c6eaaf2021abf945bb65e3cf4d7";
$compress_options['htpasswd'] = "";
$compress_options['optimization'] = "1";
$compress_options['showbeta'] = "0";
$compress_options['email'] = "webadmin@dvec.ru";
$compress_options['name'] = "";
## Active configuration
$compress_options['config'] = "auto";
## Path info. Cache directory for JS files
$compress_options['javascript_cachedir'] = "/var/www/dvec.ru/html/bitrix/tmp/wo/";
## Cache directory for CSS files
$compress_options['css_cachedir'] = "/var/www/dvec.ru/html/bitrix/tmp/wo/";
## Cache directory for HTML files
$compress_options['html_cachedir'] = "/var/www/dvec.ru/html/bitrix/tmp/wo/";
## Website installation directory
$compress_options['website_root'] = "/var/www/dvec.ru/html/";
## Document Root directory of the website
$compress_options['document_root'] = "/var/www/dvec.ru/html/";
## Host name, to include before static resources
$compress_options['host'] = "172.18.225.219";
...
$compress_options['external_scripts']['inline'] = "0";
...
$compress_options['external_scripts']['ignore_list'] = "core_window.js core_ajax.js core_admin.js utils.js admin_tools.js popup_menu.js public_tools.js crossbrowser.js jquery-1.4.2.min.js";
...
$compress_options['htaccess']['mod_expires'] = "0";
$compress_options['htaccess']['mod_headers'] = "0";
$compress_options['htaccess']['mod_setenvif'] = "0";
$compress_options['htaccess']['mod_rewrite'] = "0";
$compress_options['htaccess']['mod_mime'] = "0";
...
$compress_options['license'] = "WEBOS-ITESP-EEDUU-CE7ZZ-ZYSHW";
#########################################
?>
