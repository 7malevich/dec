...
<meta name="yandex-verification" content="e75a6e7ca3b39596" />
<?$APPLICATION->ShowHead()?>
<title><?$APPLICATION->ShowTitle()?></title>

    <meta name="description" content="Дальневосточная энергетическая компания">
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:description" content="Дальневосточная энергетическая компания">
...
<!-- важные объявления -->
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/notice_stockholder.php");?>
                            </div>
