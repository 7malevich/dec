<?
if (SITE_ID=="r4") { $hour=date("H")-1; } //амур
if (SITE_ID=="yk") { $hour=date("H")-1; } //яку
if (SITE_ID=="nr") { $hour=date("H")-1; } //нерю
if (SITE_ID=="r3") { $hour=date("H"); } //еао
if (SITE_ID=="r5") { $hour=date("H"); } //хаб
if (SITE_ID=="r6") { $hour=date("H"); } //прим
if (SITE_ID=="sk") { $hour=date("H")+1; } //сэс
if (SITE_ID=="km") { $hour=date("H")+2; } //кэс
?>
<!DOCTYPE html>
                                ...
                                <div class="header-col header-col--2 header-col--logo">
                                    <div class="header-b__img-wrap">
                                        <a href="<?=SITE_DIR?>private_clients">
                                            <span class="logo-big">
												<img class="logo-dek" src="/design2019/img/logo_<?=SITE_ID?>.png">
                                            </span>
...
<?include_once($_SERVER["DOCUMENT_ROOT"].SITE_DIR."/_includes/header_phones.php");?>
