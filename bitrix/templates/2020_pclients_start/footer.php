                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            <div class="footer-nav__address">
                                ...
                                <br>Филиал «Энергосбыт ЕАО»
								<br>679000, Россия, ЕАО, г. Биробиджан, проспект 60-летия СССР, 22А
                            </div>
                            ...
                            <div class="footer-nav__map-phones">
								<p class="footer-nav__map-phone-link">
                                    Офис в г. Биробиджан:
                                    <a href="tel:84262240904" class="footer-nav__map-phone-link">8&nbsp;(42622) 40-9-04</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                        ...
                        <div class="footer-nav__map-site-wrap">
                            ...
                            <div class="row no-gutters">
                                <a href="<?=SITE_DIR?>sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Modal -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/modal_eao.php");?>
<!-- -->
