	...
	<div class="flex-shrink-0">
		<div class="container">
			<div class="row no-gutters">
				<div class="col">
<!-- баннер нижний -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/br_btm_yakutiya.php");?>
				</div>
			</div>
		</div>
	</div>
...
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/footer_partners_yes.php");?>
                </div>
            </div>
        </div>
                ...
                <div class="row no-gutters">
                    <div class="footer-nav col-12">
                        ...
                        <div class="footer-nav__map-site-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
										<div class="footer-nav__map-link-wrap">
                                            <a href="<?=SITE_DIR?>" class="footer-nav__map-link">Частным клиентам</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                            ...
                            <div class="row no-gutters">
								<a href="/yakutiya/sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
