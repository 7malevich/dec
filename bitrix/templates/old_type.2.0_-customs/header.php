...
<!--[if lt IE 9]>
<style>
.region_top_menu_name {
left:50%; top:0px; padding: 0 0 0 190px; float: left; position:absolute; z-index:999;
}
.region_top_menu_btn {
left:50%; top:0px; padding: 0 0 0 247px; float: left; position:absolute; z-index:999;
}
</style>
<![endif]-->

<div class="regionDropDown regionDropDown1"> 
  <input type="text" onclick="showRegionMenu(1)" readonly="" id="regionValue" />
</div>
...
<!--Большой баннер-->
		<img class="bannerStart" width="903" height="285"
			 src="/images/newdesign/banner_start_customs.jpg"> 
<!--Большой баннер-->
	</div>
