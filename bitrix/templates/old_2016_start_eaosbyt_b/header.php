...
<div onclick="showRegionMenu(1)" style="background:#fed053; padding-right:3px; float:left; cursor: pointer;">Еврейская АО 
    ...
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/eaosbyt/" class="gray"><img src="/images/design2016/header_lvl3_logo_2019_dek_eao.png" title="перейти на стартовую страницу" style="height:69px;width:auto" /></a></div>
			<div style="float:right; width:154px; height:31px; margin: 10px 0 0 10px; background: url(/images/design2016/header_lvl3_oplata2.gif)"> <a href="/eaosbyt/private_clients/payment/cards_online/" class="bgblue" style="display:block; margin: 2px 2px 0 34px; font-size:16px">Оплата онлайн</a></div>
			...
			<div style="float:right; width:223px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit.gif);"> <a href="/eaosbyt/private_clients/receipts/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Заявка на эл.квитанцию</a></div>
			<div style="float:right; width:173px; height:28px; margin: 5px 0 0 0; background: url(/images/design2016/header_lvl3_vo.gif)"> <a href="/eaosbyt/private_clients/questions_answers/" class="bgblue" style="display:block; margin: 3px 2px 0 28px; font-size:16px">Вопросы и ответы</a></div>
		</div>
		<div class="hdrlvl4">
...
<div class="br_main_slider" style="width:1000px; height:400px; margin:0 auto; background-color:#fff">
	...
	<a href="/eaosbyt/private_clients/anketa/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_anketa2.jpg) no-repeat scroll center center #ffffff;">
	...
	<a href="/eaosbyt/private_clients/readings_reports/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_tel.jpg) no-repeat scroll center center #ffffff;">
...
<a class="linkblack" href="private_clients/anketa/" style="display:block; margin:30px 0 15px 0;">
	...
	<h1 style="margin: -5px 0 6px 0;line-height: 26px;">Анкета: режим работы клиентских офисов</h1>
	<p style="font: 400 16px/23px Roboto;text-align:justify;margin-bottom:20px;">Предлагаем принять участие в коротком опросе: наиболее удобный для Вас режим работы клиентских офисов &gt;&gt;&gt;</p>
</a>
</div>
...
<div id="start_brright" style="height:791px">
	...
	<a href="/organisations/edo/" style="display:block; height:110px; padding: 0 0 20px 15px"><img src="/images/design2016/br_edo.jpg" alt="Электронный документооборот для корпоративных клиентов"></a>
	...
	<div style="margin: 0 10px 0 22px; height:64px"><a href="/organisations/antirating_zhkh/"><img src="/images/design2016/icons/kran_cvet5.svg" style="display:block; float:left; margin:11px 10px 0 -4px; width:42px;">Антирейтинг предприятий ЖКХ</a></div>
	...
	<div style="margin: 0 10px 0 25px; height:64px"><a href="private_clients/service/"><img src="/images/design2016/brright_ofisy.gif" style="display:block; float:left; margin:5px 14px 0 0"/>Офисы ДЭК <br />в Еврейской АО</a></div>
