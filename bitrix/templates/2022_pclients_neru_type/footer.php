                        ...
                        <div class="footer-nav__contacts">
                            ...
                            <div class="footer-nav__map-phones">
								<p class="footer-nav__map-phone-link">
                                    ЕРИЦ г. Нерюнгри: <a href="tel:88002347777" class="footer-nav__map-phone-link">8&nbsp;(800) 234-77-77</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                            ...
                            <div class="footer-nav__virtual-reception">
                                <a href="/nerungri/private_clients/priemnaya/" class="footer-nav__virtual-reception-link">Интернет-приёмная</a>
                            </div>
...
<nav class="wysiwyg px-3">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-6">
			<a class="foo_menu" href="/nerungri/private_clients/payment/">
				Оплата
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/pokazaniya/">
				Передача показаний
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/receipts/">
				Электронная квитанция
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/priemnaya/">
				Интернет-приёмная
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/service/">
				Офисы, обслуживание
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/contact-center/">
				Единый контактный центр
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/online/">
				Услуги онлайн
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/cabinet/">
				Личный кабинет
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/dps/">
				Дополнительные услуги
			</a>
		</div>
        <div class="col-sm-12 col-lg-6">
			<a class="foo_menu" href="/nerungri/private_clients/tariffs/">
				Тарифы
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/electricity_meters/">
				Приборы учёта
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/contractual_relations/">
				Договорные отношения
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/faq/">
				Вопросы и ответы
			</a>
			<a class="foo_menu" href="/nerungri/private_clients/news/">
				Новости
			</a>
        </div>
    </div>
...
<!-- Modal -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/modal_yk_neru.php");?>
<!-- -->
