	...
	<div class="flex-shrink-0">
		<div class="container">
			<div class="row no-gutters">
				<div class="col">
<!-- баннер нижний -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/br_btm.php");?>
				</div>
			</div>
		</div>
	</div>
                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            ...
                            <div class="footer-nav__virtual-reception">
                                <a href="/amursbyt/private_clients/priemnaya/" class="footer-nav__virtual-reception-link">Интернет-приёмная</a>
                            </div>
                        ...
                        <div class="footer-nav__map-site-wrap">
                            <div class="footer-nav__map-site">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="footer-nav__map-link-wrap">
                                            <a href="<?=SITE_DIR?>private_clients/dps/" class="footer-nav__map-link">Товары и услуги</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                            ...
                            <div class="row no-gutters">
								<a href="/amursbyt/sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
