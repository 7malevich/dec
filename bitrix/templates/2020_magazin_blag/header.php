...
<title><?$APPLICATION->ShowTitle()?></title>
    ...
    <meta name="description" content="ДЭК – Интернет-магазин (Благовещенск)">
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:description" content="Дальневосточная энергетическая компания, интернет-магазин, город Благовещенск">
    <meta property="og:image" content="/images/design2016/header_lvl3_logo_2019_dek_aes.png">
    <meta property="og:site_name" content="Дальневосточная энергетическая компания - Интернет-магазин - Благовещенск">
...
<body class="d-flex flex-column h-100 hidden">
  <div id="sticky_gorod_warning" data-region="blagoveschensk" class="sticky-top hide_mobile hidden">
    <div class="alert alert-warning mb-0 pt-3 pb-3 text-center">
      Вы просматриваете интернет-магазин для города: Благовещенск.
                            ...
                            <div class="row">
                                <div class="header-col header-col--2 header-col--logo">
                                    <div class="header-b__img-wrap">
                                        <a href="/amursbyt/private_clients/">
                                            <span class="logo-big">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_aes.png" height="74">
                                            </span>
                                            <span class="logo-mobile">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_aes.png" height="36">
                                            </span>
                                        </a>
                                    </div>
                                </div>
                                <div class="header-col header-col--3 header-col--contacts">
                                    <div class="header-b__phones">
										...
										<a href="/amursbyt/private_clients/contact-center/" class="btn btn-outline-primary btn-sm" style="margin-top: 9px; border-width:1px">Единый контактный центр</a>
                                    ...
                                    <a href="/amursbyt/private_clients/cabinet/" class="header-b__card">
            ...
            <nav class="header-nav header-nav--desktop">
                <div class="row no-gutters justify-content-between">
                    <div class="header-nav__left">
						<a href="/amursbyt/private_clients/" class="header-nav__item">Частным клиентам</a>
						...
						<a href="/magazin/blagoveschensk/" class="header-nav__item is-active">Интернет-магазин</a>
                    </div>
...
<!-- мобильное меню -->
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/menu-adaptiv-amursbyt.php");?>
...
<!-- важные объявления ************************************************************** --> 
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/notice_pclients_amur.php");?>
                            </div>
