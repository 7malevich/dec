	...
	<div class="col">
		...
		<?endif;?>
			...
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				?>
				<div class="news-list-item mb-4 w-100" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="card">
						...
						<div class="card-body">
							...
							<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
								<h4 class="card-title pb-0 mb-2">
									<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
										<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="text-decoration-none"><?echo $arItem["NAME"]?></a>
									<?else:?>
										<?echo $arItem["NAME"]?>
									<?endif;?>
								</h4>
							...
							<?if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem["PREVIEW_TEXT"]):?>
								<p class="card-text pb-0 mb-2"><?echo $arItem["PREVIEW_TEXT"];?></p>
							<?endif;?>
