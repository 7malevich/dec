		...
		<div id="bx-soa-order" class="row" style="opacity: 0">
			...
			<div class="col-lg-8 col-md-7 bx-soa">
				...
				<div id="bx-soa-orderSave">
					...
					<div style="margin-top:1rem;" class="alert alert-warning mt-2">
						<p class="mb-0 mt-0 text-left">После оформления заказа с Вами свяжется менеджер магазина по указанному Вами телефону (в рабочие часы магазина).</p>
					</div>
