...
<?
if ($actualItem['CAN_BUY']) ///добавлено вручную для скрытия недоступных к покупке позиций
{
?>
					...
					<div class="product-item-info-container product-item-price-container" data-entity="price-block">
						...
						<span class="product-item-price-current" id="<?=$itemIds['PRICE']?>">
							...
							if (!empty($price))
							{
								...
								elseif ($price['RATIO_PRICE'] == 0)
								{
									echo 'По локальной смете';
								}
								else {
									echo $price['PRINT_RATIO_PRICE'];
								}
...
<? } else { ?>
<span style="display:none">предложение скрыто</span>
<? } ?>