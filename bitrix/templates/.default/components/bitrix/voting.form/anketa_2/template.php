...
<div style="padding:25px; margin:35px 0 50px 0; background-color:#deebf6; border:1px solid #96bfe2; position:relative">
<div style="position:absolute; top:-25px; left:10px; width:50px; height:50px; background-color:#468fcc; box-shadow:0 2px 3px -1px rgba(0,0,0,0.1)"><img src="/images/design2016/article/note_lamp2.png" style="width:33px; height:33px; margin:8px" /></div>
	<p>Благодарим Вас за ответы!</p>
	<ul><li><a href="3_distant.php" ><b>Перейти к следующей анкете: Дистанционные сервисы</b></a></li>
	<li><a href="./" >Вернуться к списку анкет</a></li></ul>
</div>
</div>
<?
endif;
