...
-->
		...
		{
		?>
<!-- ID и свойства пользователя не нужны
		<tr> 
...
-->		
<!-- ID посетителя и сессия не нужны
		<?
...
-->
				...
				<th><?=GetMessage("FORM_TIMESTAMP")?></th>
				<?
...
<!-- выводим статус -->
					...
					{
					?>
						<?=GetMessage("FORM_STATUS")?>:	<br />
						[&nbsp;<span class='<?=$arRes["STATUS_CSS"]?>'><?=$arRes["STATUS_TITLE"]?></span>&nbsp;]
						<br />
					<? 
					} // endif ($SHOW_STATUS == "Y")
					?>
