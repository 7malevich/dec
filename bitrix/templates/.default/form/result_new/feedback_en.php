	...
	if ($WEB_FORM_ID>0) :
		...
		if ($F_RIGHT>=10) :
			...
			if (strlen($web_form_submit)>0)
			{
				...
				if (strlen($error)<=0) 
				{
					$rsFields = CForm::GetFieldByVarname("feedback_email_en"); 
									...
									<table cellspacing="0" cellpadding="3" width="100%">
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_name_en";
										...
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_company_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_email_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_phone_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_date_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%"><?
												$FIELD_VARNAME = "feedback_phone_answ_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%" valign="top"><?
												$FIELD_VARNAME = "feedback_cust_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%" valign="top"><?
												$FIELD_VARNAME = "feedback_section_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
										...
										<tr>
											<td nowrap class="text" width="50%" valign="top"><?
												$FIELD_VARNAME = "feedback_image_en";
												$arAnswer = $arAnswers[$FIELD_VARNAME];
												$arQuestion = $arQuestions[$FIELD_VARNAME];
												echo $arQuestion["TITLE"].":";
												if($arQuestion["REQUIRED"] == "Y")
												...
												<table cellspacing="0" cellpadding="3" width="100%">
													<tr>
														<td nowrap class="text" valign="top" width="50%"><?
															$FIELD_VARNAME = "feedback_categ_en";
															$arAnswer = $arAnswers[$FIELD_VARNAME];
															$arQuestion = $arQuestions[$FIELD_VARNAME];
															echo $arQuestion["TITLE"].":";
															if($arQuestion["REQUIRED"] == "Y")
													...
													<tr>
														<td nowrap class="text" valign="top" width="50%"><?
															$FIELD_VARNAME = "feedback_message_en";
															$arAnswer = $arAnswers[$FIELD_VARNAME];
															$arQuestion = $arQuestions[$FIELD_VARNAME];
															echo $arQuestion["TITLE"].":";
															if($arQuestion["REQUIRED"] == "Y")
