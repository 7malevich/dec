...
<form action="<?echo htmlspecialchars(str_replace("#LANG_DIR#", LANG_DIR, $PAGE))?>">
<?
$nRubric = 1;
do
{
...
<tr>
	...
	<td width="100%"><font  class="smalltext"><label for="sf_RUB_ID_<?echo $nRubric?>"><?echo htmlspecialchars($rub_arr["NAME"])?></label></font></td>
</tr>
<?
	$nRubric++;
}
...
?>
<tr>
	<td colspan="2" align="center"><font size="-1"><input type="text" name="sf_EMAIL" size="15" value="<?echo htmlspecialchars(strlen($_GET["sf_EMAIL"])>0? $_GET["sf_EMAIL"] : (strlen($aSubscr["EMAIL"])>0? $aSubscr["EMAIL"]:""));?>" title="<?echo GetMessage("subscr_form_email_title")?>" class="inputfield"></font></td>
</tr>
<tr>
	<td colspan="2" align="center"><font face="Arial, Helvetica, sans-serif" size="-1"><input type="submit" name="" value="<?echo GetMessage("subscr_form_button")?>" class="inputbuttonflat"></font></td>
</tr>
</form>
<tr>
	<td colspan="2" align="center"><a href="<?echo SITE_DIR?>personal/subscribe.php" class="smalltext"><?echo GetMessage("SUBSCR_MODIFY");?></a></td>
</tr>	
</table>
<?endif;//$rub->Fetch()?>
