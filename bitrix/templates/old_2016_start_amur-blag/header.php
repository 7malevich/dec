...
<div id="topreg"></div>
<div id="br_main" style="margin:0 auto; height:618px; background: url(/images/design2016/br_main_amur_1.jpg) no-repeat scroll center bottom #ffffff;">
<header>
...
<div onclick="showRegionMenu(1)" style="float:left; cursor: pointer;">Благовещенск 
...
<![endif]-->
  ...
  <div class="region_menu_content"> 
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/amur-blag/" class="gray"><img src="/images/design2016/header_lvl3_logo-rh-hrz-w365.png" title="перейти на стартовую страницу"></a></div>
	...
	<div style="float:left; margin:342px 25px 0 25px; padding:10px 30px; height:17px; background: url(/images/design2016/start_pages/bg_ffb400_op08.png) repeat; font:400 17px/17px 'Roboto'; color:#000000; cursor:pointer" onclick="showRegionMenu(1)">Регион: Благовещенск</div>
	</div>
</div>
</header>
</div>
