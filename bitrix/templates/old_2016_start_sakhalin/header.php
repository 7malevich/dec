...
<div id="start_brright" style="height:390px; border-bottom: 1px solid #ebebeb">
	...
	<a onclick="scrollToAnchor('golos_rolik');" style="cursor:pointer; display:block; height:110px; padding: 0 0 20px 15px"><img src="/images/design2016/start_pages/brright_golos.jpg" alt="Как передать показания через систему голосового распознавания" style="width:290px; height:110px"></a>
