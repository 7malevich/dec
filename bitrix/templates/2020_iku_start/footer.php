                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            ...
                            <div class="footer-nav__virtual-reception">
                                <a href="/priemnaya/" class="footer-nav__virtual-reception-link">Интернет-приёмная</a>
                            </div>
                        ...
                        <div class="footer-nav__map-site-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
										<div class="footer-nav__map-link-wrap">
                                            <a href="/private_clients/" class="footer-nav__map-link">Частным клиентам</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="footer-nav__map-link-wrap">
                                            <a href="/dps/" class="footer-nav__map-link">Товары и услуги</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                            ...
                            <div class="row no-gutters">
                                <a href="/sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Modal -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/modal_iku.php");?>
<!-- -->
