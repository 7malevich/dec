  ...
  <div class="region_menu_content"> 
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div style="float:left; margin:362px 25px 0 25px; padding:10px 30px; height:17px; background: url(/images/design2016/start_pages/bg_ffb400_op08.png) repeat; font:400 17px/17px Roboto; color:#000000; cursor:pointer" onclick="showRegionMenu(1)">Регион: Хабаровский край</div>
	</div>
</div>
</header>
</div>
