...
<head>
  ...
  <meta name="description" content="ДЭК – Портал">
  <?$APPLICATION->ShowHead()?>
  <title><?$APPLICATION->ShowTitle()?></title>

  <link rel="stylesheet" href="/portal/assets/bootstrap.css">
  <link rel="stylesheet" href="/portal/assets/styles.css">
	<link rel="stylesheet" href="/portal/test/album/album.css">
</head>
<body>
...
<main role="main">
  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" style="background:url('/15/include/img/0-bg5.jpg') center">
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="/company/social_responsibility/volunteering/img/2021-12-24-1.jpg" class="d-block w-100">
