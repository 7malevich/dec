                ...
                <div class="row no-gutters">
                    <div class="footer-nav col-12">
                        ...
                        <div class="footer-nav__map-site-wrap">
                                ...
                                <div class="row">
                                    <div class="col-5">
										<div class="footer-nav__map-link-wrap">
                                            <a href="/nerungri/" class="footer-nav__map-link">Частным клиентам</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="footer-nav__map-link-wrap">
                                            <a href="/nerungri/private_clients/dps/" class="footer-nav__map-link">Товары и услуги</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                            ...
                            <div class="row no-gutters">
                                <a href="/nerungri/sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
