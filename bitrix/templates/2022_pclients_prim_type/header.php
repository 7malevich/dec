...
<title><?$APPLICATION->ShowTitle()?></title>
	...
	<script src="/design2019/js/dvec_head.js?5"></script>
	...
	<link href="/design2019/css/correction4.css?2306" rel="stylesheet">
    <!-- /block-head -->
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:site_name" content="Дальневосточная энергетическая компания - частным клиентам">
                                ...
                                <div class="header-col header-col--2 header-col--logo">
                                    <div class="header-b__img-wrap">
                                        <a href="/dalsbyt/private_clients">
                                            <span class="logo-big">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_des.png" height="74">
                                            </span>
                                            <span class="logo-mobile">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_des.png" height="36">
                                            </span>
                                        </a>
                                    </div>
                                </div>
	...
	"ACTIVE_COMPONENT" => "Y"
                ...
                <div class="row row--typical">
                    <div class="menu-nav-left col-md-12 col-lg-5">
                        ...
                        <nav class="typical-aside-nav mx-auto">
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "2019_left_sub",
		"DELAY" => "N",
...
<?include($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/notice_pclients_prim.php");?>
                    ...
                    <div class="col-md-12 col-lg-7 main-corr">
						<section>
                        <div class="wysiwyg">
