...
<title><?$APPLICATION->ShowTitle()?></title>
    ...
    <meta name="description" content="ДЭК – Интернет-магазин (Южно-Сахалинск)">
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:description" content="Дальневосточная энергетическая компания, интернет-магазин, город Южно-Сахалинск">
    <meta property="og:image" content="/images/design2016/header_lvl3_logo_2019_dek_ses.png">
    <meta property="og:site_name" content="Дальневосточная энергетическая компания - Интернет-магазин - Южно-Сахалинск">
...
<body class="d-flex flex-column h-100 hidden">
  <div id="sticky_gorod_warning" data-region="yusakhalinsk" class="sticky-top hide_mobile hidden">
    <div class="alert alert-warning mb-0 pt-3 pb-3 text-center">
      Вы просматриваете интернет-магазин для города: Южно-Сахалинск.
                            ...
                            <div class="row">
                                <div class="header-col header-col--2 header-col--logo">
                                    <div class="header-b__img-wrap">
                                        <a href="/sakhalin/private_clients/">
                                            <span class="logo-big">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_ses.png" height="74">
                                            </span>
                                            <span class="logo-mobile">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_ses.png" height="36">
                                            </span>
                                        </a>
                                    </div>
                                </div>
                                <div class="header-col header-col--3 header-col--contacts">
                                    ...
                                    <a href="/sakhalin/private_clients/service/" class="header-b__card">
            ...
            <nav class="header-nav header-nav--desktop">
                <div class="row no-gutters justify-content-between">
                    <div class="header-nav__left">
						<a href="/sakhalin/private_clients/" class="header-nav__item">Частным клиентам</a>
...
<!-- мобильное меню -->
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/menu-adaptiv-sakhalin.php");?>
...
<!-- важные объявления ************************************************************** --> 
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/notice_pclients_sakhalin.php");?>
                            </div>
