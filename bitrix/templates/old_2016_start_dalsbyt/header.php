...
<div id="topreg"></div>
<div id="br_main" style="margin:0 auto; height:640px; background: url(/images/design2016/br_main_prim_1b.jpg) no-repeat scroll center bottom #ffffff;">
<header>
...
<div onclick="showRegionMenu(1)" style="float:left; cursor: pointer;">Приморский край 
  ...
  <div class="region_menu_content"> 
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div style="float:right; margin:364px 25px 0 25px; padding:10px 30px; height:17px; background: url(/images/design2016/start_pages/bg_ffb400_op08.png) repeat; font:400 17px/17px 'Roboto'; color:#000000; cursor:pointer" onclick="showRegionMenu(1)">Регион: Приморский край</div>
	</div>
</div>
</header>
</div>
...
<div id="start_brright" style="height:791px">
	...
	<a href="private_clients/readings_reports/" style="display:block; height:110px; padding: 0 0 20px 15px"><img src="/images/design2016/start_pages/brright_golos.jpg" alt="Как передать показания через систему голосового распознавания" title="Как передать показания через систему голосового распознавания" style="width:290px; height:110px"></a>
