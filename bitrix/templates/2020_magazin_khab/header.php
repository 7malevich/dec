...
<title><?$APPLICATION->ShowTitle()?></title>
    ...
    <meta name="description" content="ДЭК – Интернет-магазин (Хабаровск, Хабаровскэнергосбыт)">
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:description" content="Дальневосточная энергетическая компания, Интернет-магазин, город Хабаровск">
    <meta property="og:image" content="/images/design2016/header_lvl3_logo_2019_dek_hes.png">
    <meta property="og:site_name" content="Дальневосточная энергетическая компания - интернет-магазин - Хабаровск">
...
<body class="d-flex flex-column h-100 hidden">
  <div id="sticky_gorod_warning" data-region="khabarovsk" class="sticky-top hide_mobile hidden">
    <div class="alert alert-warning mb-0 pt-3 pb-3 text-center">
      Вы просматриваете интернет-магазин для города: Хабаровск.
            ...
            <nav class="header-nav header-nav--desktop">
                <div class="row no-gutters justify-content-between">
                    <div class="header-nav__left">
						...
						<a href="/magazin/khabarovsk/" class="header-nav__item is-active">Интернет-магазин</a>
                    </div>
