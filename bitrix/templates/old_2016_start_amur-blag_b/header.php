    ...
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			...
			<div style="float:right; width:223px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit.gif);"> <a href="/amur-blag/private_clients/receipts/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Заявка на эл.квитанцию</a></div>
...
<div class="br_main_slider" style="width:1000px; height:400px; margin:0 auto; background-color:#fff">
	...
	<a href="/press_center/news_dvec/index.php?ID=17912" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_2019_spis_peni.jpg) no-repeat scroll center center #ffffff;"></a>
...
<div id="start_brright" style="height:791px">
	...
	<div style="margin: 0 15px 0 25px; height:66px"><a href="/company/disclosure/"><img src="/images/design2016/brright_raskrytie.gif" style="display:block; float:left; margin:4px 14px 0 0"/>Раскрытие информации</a></div>
	<div style="margin: 0 10px 0 25px; height:47px"><a href="private_clients/service/requests/"><img src="/images/design2016/brright_zayavki.gif" style="display:block; float:left; margin:-3px 14px 0 0"/>Заявки онлайн</a></div>
	<div style="margin: 0 10px 0 25px; height:66px"><a href="private_clients/service/"><img src="/images/design2016/brright_ofisy.gif" style="display:block; float:left; margin:5px 14px 0 0"/>Офисы ДЭК <br />в Благовещенске</a></div>
	<div style="margin: 0 10px 0 25px; height:66px"><a href="private_clients/tariffs/"><img src="/images/design2016/brright_tarify.gif" style="display:block; float:left; margin:4px 14px 0 0"/>Тарифы <br />для населения</a></div>
</div>
