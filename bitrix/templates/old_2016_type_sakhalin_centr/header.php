    ...
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			...
			<div style="float:right; width:223px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit.gif);"> <a href="/sakhalin/private_clients/receipts/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Заявка на эл.квитанцию</a></div>		</div>
		...
		<div class="hdrlvl4">
			...
			<div style="float:left; width:125px; height:30px; border-right: 1px solid #bfbfbf"><a href="/sakhalin/">ЧАСТНЫМ КЛИЕНТАМ</a></div>
