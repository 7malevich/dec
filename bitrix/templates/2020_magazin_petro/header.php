...
<title><?$APPLICATION->ShowTitle()?></title>
    ...
    <meta name="description" content="ДЭК – Интернет-магазин (Петропавловск-Камчатский)">
...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:description" content="Дальневосточная энергетическая компания, интернет-магазин, город Петропавловск-Камчатский">
    <meta property="og:image" content="/images/design2016/header_lvl3_logo_2019_dek_kes.png">
    <meta property="og:site_name" content="Дальневосточная энергетическая компания - Интернет-магазин - Петропавловск-Камчатский">
...
<body class="d-flex flex-column h-100 hidden">
  <div id="sticky_gorod_warning" data-region="petropavlovsk" class="sticky-top hide_mobile hidden">
    <div class="alert alert-warning mb-0 pt-3 pb-3 text-center">
      Вы просматриваете интернет-магазин для города: Петропавловск-Камчатский.
      <button id="sticky_gorod_warning_ok" class="btn btn-outline-secondary btn-sm ml-2" style="border-width: 1px;"><b>Понятно</b></button>
      <button id="sticky_gorod_warning_change" class="btn btn-outline-primary btn-sm ml-2" style="border-width: 1px;"><b>Выбрать другой</b></button>
    </div>
  </div>
...
<path d="M13.15 4.53769L8.832 7.41469C8.732 7.48169 8.616 7.51669 8.5 7.51669C8.384 7.51669 8.268 7.48269 8.168 7.41469L6.776 6.4877C6.734 6.4717 6.693 6.45169 6.655 6.42569L0.5 2.32269V11.7637C0.5 12.1697 0.832996 12.4977 1.243 12.4977H15.757C16.167 12.4977 16.499 12.1697 16.499 11.7637V2.30469L13.15 4.53769Z" fill="currentColor"/>
    ...
    <path d="M9.033 0a6.526 6.526 0 00-6.52 6.519c0 4.46 5.834 11.01 6.083 11.286.233.26.64.26.873 0 .249-.276 6.083-6.825 6.083-11.286A6.526 6.526 0 009.032 0zm0 9.799a3.284 3.284 0 01-3.28-3.28 3.284 3.284 0 013.28-3.28 3.284 3.284 0 013.28 3.28 3.283 3.283 0 01-3.28 3.28z" fill="currentColor"/>
                                ...
                                <div class="header-cities dropdown-menu" aria-labelledby="dropdown-city">
									...
									<p class="dropdown-item">
                                        <a onclick="RegionChangeMag('yakutsk');return false;" href="/private_clients/" class="header-city-link">
                                            Якутск
                                        </a>
                                    </p>
									<p class="dropdown-item">
                                        <a onclick="RegionChangeMag('birobidjan');return false;" href="/private_clients/" class="header-city-link">
                                            Биробиджан
                                        </a>
                                    </p>
									<p class="dropdown-item">
									...
									<p class="dropdown-item">
                                        <a onclick="RegionChangeMag('yusakhalinsk');return false;" href="/private_clients/" class="header-city-link">
                                            Южно-Сахалинск
                                        </a>
                                    </p>
									<p class="dropdown-item">
                                        <a onclick="RegionChangeMag('petropavlovsk');return false;" href="/private_clients/" class="header-city-link">
...
<path d="M9 4C5.56 4 2.442 5.754.14 8.602a.628.628 0 000 .793C2.443 12.246 5.56 14 9 14c3.44 0 6.558-1.754 8.86-4.602a.628.628 0 000-.793C15.557 5.754 12.44 4 9 4zm.247 8.52c-2.283.135-4.168-1.619-4.025-3.75.118-1.757 1.646-3.181 3.531-3.29 2.283-.135 4.168 1.619 4.025 3.75-.122 1.753-1.65 3.178-3.531 3.29zm-.114-1.626c-1.23.072-2.247-.871-2.166-2.018.063-.947.888-1.712 1.904-1.774 1.23-.072 2.246.872 2.165 2.018-.066.95-.89 1.716-1.903 1.774z" fill="currentColor" />
    ...
    <path d="M17.726 16.395L13.29 11.94a7.095 7.095 0 001.766-4.673C15.055 3.26 11.678 0 7.528 0 3.377 0 0 3.26 0 7.267c0 4.008 3.377 7.268 7.528 7.268a7.632 7.632 0 004.312-1.315l4.471 4.49c.187.187.438.29.708.29a.995.995 0 00.68-.265.926.926 0 00.027-1.34zM7.528 1.895c3.067 0 5.563 2.41 5.563 5.372 0 2.962-2.495 5.372-5.563 5.372-3.068 0-5.564-2.41-5.564-5.372 0-2.961 2.496-5.371 5.564-5.371z" fill="#165280"/>
                                    ...
                                    <div class="header-fixed-nav--search-input-wrap dropdown-menu header-nav__dropdown-menu dropdown-menu-right" aria-labelledby="dropdownSearch">
                                        <form action="/petropavlovsk/search" method="get" id="topSearchForm">
                            ...
                            <div class="row">
                                <div class="header-col header-col--2 header-col--logo">
                                    <div class="header-b__img-wrap">
                                        <a href="/kamchatka/private_clients/">
                                            <span class="logo-big">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_kes.png" height="74">
                                            </span>
                                            <span class="logo-mobile">
												<img class="logo-dek" src="/images/design2016/header_lvl3_logo_2019_dek_kes.png" height="36">
                                            </span>
                                        </a>
                                    </div>
                                </div>
                                <div class="header-col header-col--3 header-col--contacts">
                                    ...
                                    <a href="/kamchatka/private_clients/cabinet/" class="header-b__card">
            ...
            <nav class="header-nav header-nav--desktop">
                <div class="row no-gutters justify-content-between">
                    <div class="header-nav__left">
						<a href="/kamchatka/private_clients/" class="header-nav__item">Частным клиентам</a>
						...
						<a href="/magazin/petropavlovsk/" class="header-nav__item is-active">Интернет-магазин</a>
                    </div>
...
<!-- мобильное меню -->
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/menu-adaptiv-kamchatka.php");?>
                            ...
                            <a class="btn collapse-menu-btn collapsed" data-toggle="collapse" href="#collapseMenuRegion" role="button" aria-expanded="false" aria-controls="collapseMenuRegion">
                                ...
                                <div class="collapse collapse-menu" id="collapseMenuRegion">
                                    <div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('blagoveschensk');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Благовещенск
                                        </a>
                                    </div>
									<div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('yakutsk');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Якутск
                                        </a>
                                    </div>
									<div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('birobidjan');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Биробиджан
                                        </a>
                                    </div>
									<div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('khabarovsk');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Хабаровск
                                        </a>
                                    </div>
									<div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('yusakhalinsk');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Южно-Сахалинск
                                        </a>
                                    </div>
									<div class="collapse-menu__card">
                                        <a onclick="RegionChangeMag('petropavlovsk');return false;" href="/private_clients/" class="collapse-menu__link">
                                            Петропавловск-Камчатский
                                        </a>
                                    </div>
                                </div>
...
<!-- важные объявления ************************************************************** --> 
<?require_once($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/notice_pclients_kamchatka.php");?>
                            </div>
