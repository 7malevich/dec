                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            ...
                            <div class="footer-nav__virtual-reception">
                                <a href="/kamchatka/private_clients/priemnaya/" class="footer-nav__virtual-reception-link">Интернет-приёмная</a>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
										<div class="footer-nav__map-link-wrap">
                                            <a href="/kamchatka/private_clients/" class="footer-nav__map-link">Частным клиентам</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="footer-nav__map-link-wrap">
                                            <a href="/kamchatka/private_clients/dps/" class="footer-nav__map-link">Товары и услуги</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
