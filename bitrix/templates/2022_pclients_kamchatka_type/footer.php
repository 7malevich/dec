                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            <div class="footer-nav__address">
                                ...
                                <br>Филиал «Камчатскэнергосбыт»
								<br>683006 г.&nbsp;Петропавловск-Камчатский, пр.&nbsp;Победы,&nbsp;24
                            </div>
                            ...
                            <div class="footer-nav__map-phones">
                                <p class="footer-nav__map-phone-link">
                                    Приемная (Петропавловск-Камчатский): 
                                    <a href="tel:84152490900" class="footer-nav__map-phone-link">8&nbsp;(4152) 49-09-00</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                                    Контакт-центр: <br>
...
<nav class="wysiwyg px-3">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-6">
			<a class="foo_menu" href="/kamchatka/private_clients/payment/">
				Оплата
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/pokazaniya/">
				Передача показаний
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/receipts/">
				Электронная квитанция
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/priemnaya/">
				Интернет-приёмная
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/service/">
				Офисы, обслуживание
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/contact-center/">
				Единый контактный центр
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/online/">
				Услуги онлайн
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/cabinet/">
				Личный кабинет
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/dps/">
        ...
        <div class="col-sm-12 col-lg-6">
			<a class="foo_menu" href="/kamchatka/private_clients/tariffs/">
				Тарифы
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/electricity_meters/">
				Приборы учета
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/contractual_relations/">
				Договорные отношения
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/odn/">
				Общедомовые нужды
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/power_savings/">
				Энергосбережение
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/voprosy/">
				Вопросы и ответы
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/uvedomleniya/">
				Уведомления собственникам помещений
			</a>
			<a class="foo_menu" href="/kamchatka/private_clients/news/">
				Новости
			</a>
        </div>
    </div>
...
<!-- Modal -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/modal_kamchatka.php");?>
<!-- -->
