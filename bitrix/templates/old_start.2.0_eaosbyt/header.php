			...
			<div class="topSection">
				...
				<div class="sectionBlock links">
					...
					<div style="padding: 7px 0 0; height: 28px;">
						<a href="/eaosbyt/" class="icon-home"><img border="0" src="/images/newdesign/icon_small_home.gif"></a>
						<a href="/eaosbyt/" class="gray home">Главная</a>
						<span class="l">|</span>
...
<div class="region_top_menu_name">Еврейская АО</div>
...
<!-- Лого и меню -->
			<div class="topNav">
				<a class="logoText" href="/eaosbyt/"></a>
...
<!--Большой баннер-->
<img class="bannerStart" width="903" height="285" src="/images/newdesign/br_main_eao_20160310.jpg">

<!--Главные иконки-->
	<ul class="centerMenu">
		<li><a href="/eaosbyt/private_clients/cabinet/">
				<img border="0" src="/images/newdesign/icon_cabinet.png" width="48" height="62">
			</a>
			<a href="/eaosbyt/private_clients/cabinet/" class="label cabinet"></a>
		</li>
		<li><a href="/eaosbyt/private_clients/contractual_relations/order_conclusion_contracts/">
				<img border="0" src="/images/newdesign/icon_connect.png" width="69" height="56">
			</a>
			<a href="/eaosbyt/private_clients/contractual_relations/order_conclusion_contracts/" class="label connect"></a>
		</li>
		<li><a href="/eaosbyt/private_clients/payment/">
				<img border="0" src="/images/newdesign/icon_payment.png" width="50" height="58">
			</a>
			<a href="/eaosbyt/private_clients/payment/" class="label payment"></a>
		</li>
		<li><a href="/eaosbyt/private_clients/service/">
				<img border="0" src="/images/newdesign/icon_services.png" width="72" height="60">
			</a>
			<a href="/eaosbyt/private_clients/service/" class="label services"></a>
		</li>
		<li><a href="/eaosbyt/private_clients/tariffs/">
				<img border="0" src="/images/newdesign/icon_tariffs.png" width="45" height="58">
			</a>
			<a href="/eaosbyt/private_clients/tariffs/" class="label tariffs"></a>
		</li>
		<li><a href="/eaosbyt/private_clients/questions_answers/">
				<img border="0" src="/images/newdesign/icon_faq.png" width="45" height="62">
			</a>
			<a href="/eaosbyt/private_clients/questions_answers/" class="label faq"></a>
		</li>
		<!--<li><a href="/eaosbyt/private_clients/">
				<img border="0" src="/images/newdesign/icon_cabinet.png" width="48" height="62">
			</a>
			<a href="/eaosbyt/private_clients/" class="label cabinet"></a>
		</li>-->
	</ul>
