...
<div onclick="showRegionMenu(1)" style="background:#fed053; padding-right:3px; float:left; cursor: pointer;">Нерюнгринский район РС(Я) 
    ...
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/yakutiya/" class="gray"><img src="/images/design2016/header_lvl3_logo_2019_dek_aes.png" title="перейти на стартовую страницу" style="height:69px;width:auto" /></a></div>
			<div style="float:right; width:154px; height:31px; margin: 14px 0 0 8px; background: url(/images/design2016/header_lvl3_oplata2.gif)"> <a onclick="scrollToAnchor('oplata');" class="bgblue" style="cursor:pointer; display:block; margin: 2px 2px 0 34px; font-size:16px">Оплата онлайн</a></div>
			...
			<div style="float:right; width:307px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit2.gif);"> <a href="/yakutiya/kvitancii/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Отказаться от бумажной квитанции</a></div>
...
<div class="br_main_slider" style="width:1000px; height:400px; margin:0 auto; background-color:#fff">
	<!-- <a href="/yakutiya/pokazaniya/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_tel.jpg) no-repeat scroll center center #ffffff;">
	...
	<!-- <a href="/press_center/news_dvec/index.php?ID=17924" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_2019_spis_peni.jpg) no-repeat scroll center center #ffffff;"></a>
-->
	<a href="/yakutiya/anketa/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_anketa2.jpg) no-repeat scroll center center #ffffff;">
...
<div id="start_brright" style="height:260px">
	...
	<!-- <a href="/press_center/news_dvec/index.php?ID=17924" style="display:block; padding: 0 0 17px 15px"><img src="/images/design2016/start_pages/brright_2019penya2.jpg" title="Акция по списанию пени. Ознакомиться с условиями акции" style="width:290px; height:110px"></a>
-->
