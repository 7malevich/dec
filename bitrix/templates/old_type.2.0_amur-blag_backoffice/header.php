...
<!--Большой баннер-->
		<img class="bannerStart" width="903" height="285"
			 src="/images/newdesign/br_main_amur-blag_winter_20160310.jpg">
<!--Большой банер-->
	</div>
...
<a href="/amur-blag/private_clients/readings_reports/"><img src="/images/newdesign/br-pokazaniya.gif" style="float:none; margin-top:10px"></a>
</div>
-->

<!-- основной контент -->
		<div class="col right large round" style="width:905px">
			<div class="corners top">
				<div class="c left"></div><div class="c right"></div>
			</div>
			<div class="inner">
