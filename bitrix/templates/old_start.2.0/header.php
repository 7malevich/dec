			...
			<div class="topSection">
				...
				<div class="sectionBlock links">
					...
					<div style="padding: 7px 0 0; height: 28px;">
						<a href="/" class="icon-home"><img border="0" src="/images/newdesign/icon_small_home.gif"></a>
						<a href="/" class="gray home">Главная</a>
						<span class="l">|</span>
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="903" height="285" id="FlashID" title="Дальневосточная энергетическая компания">
       <param name="movie" value="/images/newdesign/br_main_130814_hab.swf" />
       ...
       <!--[if !IE]>-->
       <object type="application/x-shockwave-flash" data="/images/newdesign/br_main_130814_hab.swf" width="903" height="285">
         <!--<![endif]-->
         <param name="quality" value="high" />
         <param name="wmode" value="opaque" />
         <param name="swfversion" value="6.0.65.0" />
...
<!--Главные иконки-->
	<ul class="centerMenu">
		<li><a href="/private_clients/cabinet/">
				<img border="0" src="/images/newdesign/icon_cabinet.png" width="48" height="62">
			</a>
			<a href="/private_clients/cabinet/" class="label cabinet"></a>
		</li>
		<li><a href="/private_clients/contractual_relations/order_conclusion_contracts/">
				<img border="0" src="/images/newdesign/icon_connect.png" width="69" height="56">
			</a>
			<a href="/private_clients/contractual_relations/order_conclusion_contracts/" class="label connect"></a>
		</li>
		<li><a href="/private_clients/payment/">
				<img border="0" src="/images/newdesign/icon_payment.png" width="50" height="58">
			</a>
			<a href="/private_clients/payment/" class="label payment"></a>
		</li>
		<li><a href="/private_clients/service/">
				<img border="0" src="/images/newdesign/icon_services.png" width="72" height="60">
			</a>
			<a href="/private_clients/service/" class="label services"></a>
		</li>
		<li><a href="/private_clients/tariffs/">
				<img border="0" src="/images/newdesign/icon_tariffs.png" width="45" height="58">
			</a>
			<a href="/private_clients/tariffs/" class="label tariffs"></a>
		</li>
		<li><a href="/private_clients/questions_answers/">
				<img border="0" src="/images/newdesign/icon_faq.png" width="45" height="62">
			</a>
			<a href="/private_clients/questions_answers/" class="label faq"></a>
		</li>
		<!--<li><a href="/private_clients/">
				<img border="0" src="/images/newdesign/icon_cabinet.png" width="48" height="62">
			</a>
			<a href="/private_clients/" class="label cabinet"></a>
		</li>-->
	</ul>
