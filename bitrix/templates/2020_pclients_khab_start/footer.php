	...
	<div class="flex-shrink-0">
		<div class="container">
			<div class="row no-gutters">
				<div class="col">
<!-- баннер нижний -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/br_btm_khab.php");?>
				</div>
			</div>
		</div>
	</div>
...
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/footer_partners.php");?>
                </div>
            </div>
        </div>
                    ...
                    <div class="footer-nav col-12">
                        <div class="footer-nav__contacts">
                            <div class="footer-nav__address">
                                ...
                                <br>Филиал «Хабаровскэнергосбыт»
								<br>680030, Россия, Хабаровский край, г. Хабаровск, ул. Слободская 12
                            </div>
                            ...
                            <div class="footer-nav__map-phones">
                                <p class="footer-nav__map-phone-link">
                                    ЕРИЦ г.&nbsp;Комсомольск-на-Амуре: <br>
                                    <a href="tel:84217523000" class="footer-nav__map-phone-link">8&nbsp;(4217) 52-30-00</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                                    ЕРИЦ г.&nbsp;Амурск: 
                                    <a href="tel:84214220735" class="footer-nav__map-phone-link">8&nbsp;(42142) 2-07-35</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                                    ЕРИЦ г.&nbsp;Вяземский: 
                                    <a href="tel:84215331967" class="footer-nav__map-phone-link">8&nbsp;(42153) 3-19-67</a>
                                </p>
								<p class="footer-nav__map-phone-link">
                        ...
                        <div class="footer-nav__map-site-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
										<div class="footer-nav__map-link-wrap">
                                            <a href="<?=SITE_DIR?>private_clients/" class="footer-nav__map-link">Частным клиентам</a>
                                        </div>
                                        <div class="footer-nav__map-link-wrap">
                            ...
                            <div class="row no-gutters">
								<a href="/khabsbyt/sitemap/" class="btn btn--footer-map-site">Карта сайта</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row no-gutters">
                    <div class="footer-nav-bootom col-12">
                        ...
                        <div class="pitcher-logo">
                            <a href="https://www.intecmedia.ru/services/sozdanie-sajtov/razrabotka-dizajna-sajta/?utm_source=dvec.ru&utm_medium=copyright&utm_campaign=all" target="_blank" class="pitcher-logo__link" alt="pitcher">
                                <span class="pitcher-logo__title">Разработка дизайна</span>
...
<!-- Modal -->
<?require($_SERVER["DOCUMENT_ROOT"]."/design2019/pages/modal_khab.php");?>
<!-- -->
