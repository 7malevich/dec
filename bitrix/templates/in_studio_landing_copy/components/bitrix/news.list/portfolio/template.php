...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="portfolio <?echo $arItem["DISPLAY_PROPERTIES"]["VIDY_RABOT"]["VALUE"]?>" data-cat="<?echo $arItem["DISPLAY_PROPERTIES"]["VIDY_RABOT"]["VALUE"]?>" href="#portfolioModal<?=$arItem['ID']?>" data-toggle="modal">
		<div class="portfolio-wrapper">
			<img class="border-round" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="<?echo $arItem["NAME"]?>">
			<div class="caption">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <img src="<?=$arItem['DETAIL_PICTURE']['SRC']?>" class="img-responsive img-centered border-round shadowed" alt="">
                        </div>
                        <div class="col-lg-8 col-lg-offset-2">
							<div style="margin-bottom:35px;font-size:1.25em"><?echo $arItem["DETAIL_TEXT"]?></div>
