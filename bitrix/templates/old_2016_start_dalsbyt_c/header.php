...
<div onclick="showRegionMenu(1)" style="background:#fed053; padding-right:3px; float:left; cursor: pointer;">Приморский край 
    ...
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<!-- <div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/dalsbyt/" class="gray"><img src="/images/design2016/header_lvl3_logo-rh-hrz-w365.png" title="перейти на стартовую страницу" /></a></div>
			<div style="float:right; width:154px; height:31px; margin: 24px 0 0 8px; background: url(/images/design2016/header_lvl3_oplata2.gif)"> <a href="private_clients/payment/cards_online/" class="bgblue" style="display:block; margin: 2px 2px 0 34px; font-size:16px">Оплата онлайн</a></div>
			<div style="float:right; width:194px; height:31px; margin: 24px 0 0 0; background: url(/images/design2016/header_lvl3_pokazanya2.gif)"> <a href="/pokazaniya/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Передача показаний</a></div>
		</div> -->
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/dalsbyt/" class="gray"><img src="/images/design2016/header_lvl3_logo_2019_dek_des.png" title="перейти на стартовую страницу" style="height:69px;width:auto" /></a></div>
			<div style="float:right; width:154px; height:31px; margin: 10px 0 0 10px; background: url(/images/design2016/header_lvl3_oplata2.gif)"> <a href="/dalsbyt/private_clients/payment/cards_online/" class="bgblue" style="display:block; margin: 2px 2px 0 34px; font-size:16px">Оплата онлайн</a></div>
			...
			<div style="float:right; width:307px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit2.gif);"> <a href="/dalsbyt/private_clients/receipts/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Отказаться от бумажной квитанции</a></div>
			<div style="float:right; width:173px; height:28px; margin: 5px 0 0 0; background: url(/images/design2016/header_lvl3_vo.gif)"> <a href="/dalsbyt/private_clients/questions_answers/" class="bgblue" style="display:block; margin: 3px 2px 0 28px; font-size:16px">Вопросы и ответы</a></div>
		</div>
		<div class="hdrlvl4">
...
<!--	<a href="/pokazaniya/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_batareya.jpg) no-repeat scroll center center #ffffff;">
		<div style="position:absolute; bottom:20px; right:15px; background:rgba(13,79,156,.8); padding:20px"><span style="color:white; font-size:22px">
			Уважаемые клиенты г. Владивостока! Теперь передать показания индивидуальных приборов учета по ГВС и отоплению Вы можете на сайте ПАО «ДЭК» 
или через интернет-сервис «Личный кабинет». <!-- Успейте передать показания с 20 по 25 число! --><!-- </span></div></a> -->
	...
	<a href="/press_center/news_dvec/index.php?ID=17877" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_2019_spis_peni.jpg) no-repeat scroll center center #ffffff;">
		<div style="position:absolute; bottom:20px; right:15px; background:rgba(13,79,156,.8); padding:20px;"><span style="color:white; font-size:22px">
			Ознакомиться с условиями акции &gt;&gt;&gt;</span></div>
	</a> -->
	<a href="/dalsbyt/private_clients/anketa/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_anketa2.jpg) no-repeat scroll center center #ffffff;">
	...
	<a href="/dalsbyt/private_clients/charge/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_charge_1.jpg) no-repeat scroll center center #ffffff;">
		<div style="position:absolute; bottom:20px; right:15px; background:rgba(13,79,156,.8); padding:20px"><span style="color:white; font-size:22px">
		Сеть быстрых зарядных станций РусГидро для электромобилей</span></div></a>
<!--	<a href="/press_center/news_dvec/index.php?ID=17830" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_eric_uss.jpg) no-repeat scroll center center #ffffff;">
		<div style="position:absolute; bottom:20px; right:15px; background:rgba(13,79,156,.8); padding:20px"><span style="color:white; font-size:22px">
		РусГидро открыло Единый расчётно-информационный центр в г. Уссурийске</span></div></a> -->
 	<a href="/dalsbyt/private_clients/readings_reports/" style="display:block; width:1000px; height:400px; background:url(/images/design2016/br_main_tel.jpg) no-repeat scroll center center #ffffff;">
...
<!-- <div style="display:block; margin:-5px 0 25px 0;height: 110px;">
	<img src="/images/design2016/icons/lampochka.svg" style="float:left;width:64px;margin: 1px 25px 20px 0;">
	<h1 style="margin-bottom: 10px;">Объявление о работе контакт-центра</h1>
	<p style="font: 400 16px/23px Roboto;text-align:justify;margin-bottom:10px;">
Уважаемые клиенты! В связи с профилактическими работами возможо временное отсутствие доступности телефонной линии 8 800 100 3 777 с 15:00 до 16:00 в понедельник 09.12.2019.</p>
</div> -->
...
<a class="linkblack" href="/press_center/news_dvec/?ID=17910" style="display:block; margin:30px 0 15px 0;">
	<img style="float:left;width:64px;height:auto;margin: 4px 25px 50px 0;" src="/images/design2016/icons/ruble.svg">
	<h1 style="margin: -5px 0 6px 0;line-height: 26px;">Произведен перерасчет по тепловой энергии за 2017 год для домов Владивостока, подключенных от центральных тепловых пунктов</h1>
	<p style="font: 400 16px/23px Roboto;text-align:justify;margin-bottom:20px;">Полный перечень домов &gt;&gt;&gt;</p>
</a>
</div>
...
<div id="start_brright" style="height:661px">
	...
	<a href="/press_center/news_dvec/index.php?ID=17877" style="display:block; padding: 0 0 17px 15px"><img src="/images/design2016/start_pages/brright_2019penya2.jpg" title="Акция по списанию пени. Ознакомиться с условиями акции" style="width:290px; height:110px"></a>
-->
	...
	<div style="margin: 0 10px 0 25px; height:64px"><a href="private_clients/anketa/"><img src="/images/design2016/brright_anketa_003aa6.png" style="display:block; float:left; margin:0 14px 0 0">Анкета для <br>частных клиентов</a></div>
	...
	<div style="margin: 0 10px 0 25px; height:64px"><a href="private_clients/service/"><img src="/images/design2016/brright_ofisy.gif" style="display:block; float:left; margin:5px 14px 0 0"/>Офисы ДЭК <br />в Приморском крае</a></div>
