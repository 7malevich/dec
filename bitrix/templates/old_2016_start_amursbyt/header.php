...
<div onclick="showRegionMenu(1)" style="float:left; cursor: pointer;">Амурская область 
...
<![endif]-->
  ...
  <div class="region_menu_content"> 
    <div id="r_menu"> 	 
      ...
      <div class="region_item" region="yakutiya" dir_path="\"> 		<span> 		Нерюнгринский район РС(Я)		</span> 	</div>
		...
		<div class="hdrlvl3" style="width:950px; height:95px; padding: 0 25px">
			<div style="float:left; width:405px; padding:9px 12px 0 0"><a href="/amursbyt/" class="gray"><img src="/images/design2016/header_lvl3_logo-rh-hrz-w365.png" title="перейти на стартовую страницу"></a></div>
			...
			<div style="float:right; width:223px; height:29px; margin: 6px 0 0 10px; background: url(/images/design2016/header_lvl3_kvit.gif);"> <a href="/amursbyt/private_clients/receipts/" class="bgblue" style="display:block; margin: 2px 2px 0 30px; font-size:16px">Заявка на эл.квитанцию</a></div>
	...
	<div style="float:left; margin:342px 25px 0 25px; padding:10px 30px; height:17px; background: url(/images/design2016/start_pages/bg_ffb400_op08.png) repeat; font:400 17px/17px 'Roboto'; color:#000000; cursor:pointer" onclick="showRegionMenu(1)">Регион: Амурская область</div>
	</div>
</div>
</header>
</div>
