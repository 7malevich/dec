...
?><p class="text-left">Запись на очный прием в Едином расчетно-информационном центре по адресу: <br>Петропавловск-Камчатский, проспект Карла Маркса, 5.
</p>
<style>
...
<div id="msg" class="alert alert-success" role="alert" style="display:none; padding:2rem 1.75rem; clear:both; align-items:center">
		...
		<div>
			...
			<h1 class="mt-0 mb-0">Запишите номер талона: <span id="msg_pincode">XXXX</span></h1>
		</div>
</div>
