...
if (($_COOKIE['dvec_meter_mpi_gvs']) and (intval($_COOKIE['dvec_meter_mpi_gvs']) < 91) and (($_COOKIE['dvec_pokazaniya_gvs'] == 'amursbyt') or ($_COOKIE['dvec_pokazaniya_gvs'] == 'amur-epd')))
