...
if ($meter['scales'] == 2) {
$shkala_msg1='Показания и расчетные начисления по первой шкале:';
}
if ($meter['scales'] == 3) {
...
<?php if ($meter['scales'] == 3): ?>
  ...
  <?php if ($meter['scales'] == 2): ?>
    <tr>
      <th colspan="2"><span id="reading2title" style="font-size: 12pt; padding-right: 50px;">Показания и расчетные начисления по второй шкале:</span></th>
    </tr>
    <tr>
      <td style="width: 1px; white-space: nowrap">Предыдущие показания</td>
      <td>
