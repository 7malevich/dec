...
<div style="width:480px; padding:5px 15px; margin:20px auto; background-color:#fbefe7; border:1px solid #e2b896;">
  <p style="font-size:14px;">В поле &quot;Текущие показания&quot; необходимо ввести все цифры, которые Вы видите на шкале прибора учета. Разделитель вводить не нужно. Например показания Вашего прибора учета <strong>00522,341</strong>. Необходимо ввести <strong>00522341</strong> и нажать &quot;Отправить&quot;.</p>  
</div>
...
<p id="dopusluga" style="font-size:13px; line-height:15px; text-align:left">
   <?php echo htmlspecialchars($alarm['alarm1']); ?>
</p>
<p style="font-size:13px; line-height:15px; text-align:left">
  <?php echo htmlspecialchars($alarm['alarm2']); ?>
</p>
<!-- <p style="font-size:13px; line-height:15px; text-align:left">
   При эксплуатации ПУ с истекшим сроком поверки начисление платы за ГВС производится:</br>
