...
<p>Спасибо! Ваши показания получены и будут переданы в дальнейшую обработку.<br>
Если Вы хотите передать показания еще по одному прибору учета, перейдите по ссылке:</p>
...
<p>В таком случае закажите обратный звонок, и специалисты ДЭК перезвонят Вам и проконсультируют о том, как исправить эту проблему и избежать повышенных счетов:</p>
