		...
		<div class="col-lg-10 col-lg-offset-1">
			<div class="testimonials-carousel">
				...
				<div class="item" style="text-align:center">
					...
					<hr class="border-orange mt15px">
					<h3>К зоне обслуживания филиала «Амурэнергосбыт» присоединен Нерюнгринский район Республики Саха (Якутия).</h3>
					<div style="height:70px"></div>
				</div>
				<div class="item" style="text-align:center">
...
<section id="territoriya" style="background-color:rgb(20,89,154)">
	<div class="row text-center content-row">
		...
		<div class="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.8s">
			<img src="include/img/1-b3.png" class="img-responsive">
		</div>
	</div>
<div class="container wow fadeIn">
	<div class="row text-justify" style="margin-top:35px">
		<div class="col-sm-12 text-white">
			<p>За 15 лет ПАО «ДЭК» расширило свое присутствие с четырех до семи регионов Дальнего Востока, увеличив  количество обслуживаемых клиентов более чем в два раза. Количество оказываемых населению и предприятиям Дальнего Востока услуг возросло в десятки раз.  Сегодня компания ведет свою деятельность  на территории Приморского края, Хабаровского края, Амурской области, ЕАО, Сахалинской области, Камчатского края, Республики Саха (Якутия).</p>
			<p>В 2021 году с принятием сбытовых функций в Якутии, Дальневосточная энергетическая компания становится крупнейшей по территории обслуживания энергосбытовой компанией России.  Сегодня ДЭК обслуживает 3,4 млн лицевых счетов частных и 103 тыс. корпоративных клиентов, оказывая очные консультации в 191 офисе от Сахалина до Якутии.</p>
		</div>
	</div>
</div>
</section> 
...
<div id="map" style="width: 100%; height: 520px; margin:50px 0 0 0"></div>
</section><?
