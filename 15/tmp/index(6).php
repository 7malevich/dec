...
<section id="territoriya" style="background-color:rgb(20,89,154)">
	<div class="row text-center content-row">
		...
		<div class="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.8s">
			<img src="include/img/1-b4.png" class="img-responsive">
		</div>
	</div>
<div class="container wow fadeIn">
	<div class="row text-justify" style="margin-top:35px">
		<div class="col-sm-12 text-white">
			<p>За 15 лет ПАО «ДЭК» расширило свое присутствие с четырех до семи регионов Дальнего Востока, увеличив количество обслуживаемых клиентов в два раза, а объем поставляемой энергии -  в 1,5. Количество оказываемых населению и предприятиям Дальнего Востока услуг возросло в десятки раз.  Сегодня компания ведет свою деятельность  на территории Приморского края, Хабаровского края, Амурской области, ЕАО, Сахалинской области, Камчатского края, Республики Саха (Якутия).</p>
			<p>В 2021 году с принятием сбытовых функций в Якутии, Дальневосточная энергетическая компания становится крупнейшей по территории обслуживания энергосбытовой компанией России. ДЭК обслуживает 3,4 млн лицевых счетов частных и 103 тыс. корпоративных клиентов, оказывая очные консультации в 191 офисе от Сахалина до Якутии, реализуя свыше 28,2 млрд кВт·ч ежегодно.  </p>
		</div>
	</div>
</div>
</section> 
...
<section id="charge" class="bg-dark bg-violet" style="padding-bottom:0">
	...
	<div class="row">
		<div class="col-md-6 text-center">
			...
			<p style="font-size:1.2em">На сегодняшний день действует сеть из 51 быстрых зарядных станций Группы РусГидро для электромобилей. Они расположены в 19 городах Приморского и Хабаровского краев, Камчатского края и Сахалинской области.</p>
...
<div style="position:relative;overflow:hidden"><a href="https://yandex.ru/maps?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;">Яндекс.Карты</a><a href="https://yandex.ru/maps/?from=api-maps&ll=145.508141%2C52.610612&mode=usermaps&origin=jsapi_2_1_79&um=constructor%3Ac1a1491d33a659572000772c3f0794d48d6b022f672064fffcdb0265ce1cf144&utm_medium=mapframe&utm_source=maps&z=4.8" style="color:#eee;font-size:12px;position:absolute;top:14px;">Яндекс.Карты — транспорт, навигация, поиск мест</a><iframe src="https://yandex.ru/map-widget/v1/-/CCU5eMx-GC" width="100%" height="510px" frameborder="0" allowfullscreen="true" style="position:relative"></iframe></div>
</section><?
