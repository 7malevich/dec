...
$APPLICATION->SetTitle("Все способы передачи показаний, инструкция");
...
<p>ПАО «ДЭК» предлагает жителям Республики Саха (Якутия) следующие способы передачи показаний приборов учёта:
</p>
<ol>
	<li><a href="../../cabinet/">Через Личный кабинет (в том числе мобильное  приложение)</a></li>
  <li>
	<span>
		<b>Через Единый контакт-центр ПАО «ДЭК» по телефону 8-800-234-7777.</b>
		<br>
		Для передачи показаний вам необходимо, следуя инструкции виртуального помощника, назвать номер лицевого счета, указанный в платежном документе, и показания приборов учета.
	</span>
	<div class="spoiler folded">Схема работы сервиса автоматизированного приема показаний путем системы голосового распознавания: (нажмите, чтобы развернуть)</div>
	...
	<li><a href="../">На сайте ПАО «ДЭК».</a></li>
</ol>


<h4 class="mt-5">Почему важно передавать показания?</h4>
...
<h4 class="mt-5">Как снимать и передавать показания приборов&nbsp;учёта:</h4>
...
<p>  В срок с 20 по 25 число каждого месяца передать снятые показания в ПАО «ДЭК» или свою Управляющую  компанию (ТСЖ, ТСН, ЖСК).</p>
</div>
