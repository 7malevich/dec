...
?><div class="alert alert-info mb-4 d-flex p-3 justify-content-center align-items-center" role="alert">
	<span style="padding-right: 1rem;opacity: 0.3;font-size:4rem;">⚠</span>
	<span><a href="/yakutiya/private_clients/service/docs/" target="_blank"><b>Как подготовить документы перед обращением в Интернет-приемную, посещением офиса Якутскэнергосбыта</b></a></span>
</div>
