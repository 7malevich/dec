...
$APPLICATION->SetTitle("Запись в офис онлайн: расписание (Якутск, Рыдзинского 24 Б, Манньыттаах)");
?>
...
function lookToday() {
	...
	var url = '../5timetable.php?date1=' + date1 + '&date2=' + date2 + '&qid=yes_yk_rydzinskogo';
...
function lookStats() {
	...
	var url = '../6stats.php?date1=' + date1 + '&date2=' + date2 + '&qid=yes_yk_rydzinskogo';
...
function DeleteZapis2() {
	...
	var url = '../7delete.php?line=' + lineid + '&qid=yes_yk_rydzinskogo';
