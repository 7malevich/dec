...
$to = 'kassa_mana2@yakutskenergo.ru, ekc-nach@amur.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (Якутск, Рыдзинского 24 Б, Манньыттаах)';

$file = $_SERVER["DOCUMENT_ROOT"]."/yakutiya/private_clients/service/queue/yes_yk_rydzinskogo/queue.txt";
$content = file($file);
