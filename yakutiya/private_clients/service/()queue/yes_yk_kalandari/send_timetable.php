...
$to = 'kassa_kalan@yakutskenergo.ru, ekc-nach@amur.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (Якутск, Каландаришвили 25, Якутжилстрой)';

$file = $_SERVER["DOCUMENT_ROOT"]."/yakutiya/private_clients/service/queue/yes_yk_kalandari/queue.txt";
$content = file($file);
