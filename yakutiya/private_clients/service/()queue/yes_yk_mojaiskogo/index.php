...
$APPLICATION->SetTitle("Запись в офис онлайн: расписание (Якутск, Можайского 27А, Белое озеро)");
?>
...
function lookToday() {
	...
	var url = '../5timetable.php?date1=' + date1 + '&date2=' + date2 + '&qid=yes_yk_mojaiskogo';
...
function lookStats() {
	...
	var url = '../6stats.php?date1=' + date1 + '&date2=' + date2 + '&qid=yes_yk_mojaiskogo';
...
function DeleteZapis2() {
	...
	var url = '../7delete.php?line=' + lineid + '&qid=yes_yk_mojaiskogo';
