...
$to = 'kassa_port@yakutskenergo.ru, ekc-nach@amur.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (Якутск, Можайского 27А, Белое озеро)';

$file = $_SERVER["DOCUMENT_ROOT"]."/yakutiya/private_clients/service/queue/yes_yk_mojaiskogo/queue.txt";
$content = file($file);
