...
$to = 'kassa_1000@yakutskenergo.ru, ekc-nach@amur.dvec.ru';
$subject = 'Расписание предварительной записи на ' . date_create('now')->format('d.m.Y') . ' (Якутск, Октябрьская 25, Тит-Ары)';

$file = $_SERVER["DOCUMENT_ROOT"]."/yakutiya/private_clients/service/queue/yes_yk_titary/queue.txt";
$content = file($file);
