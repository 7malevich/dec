...
<div class="alert alert-warning">Уважаемые клиенты! Обратите внимание, в связи со сменой лицевых счетов необходимо вводить <u>новый</u> номер лицевого счета, указанный в платежном документе за август.</div>
...
<div id="pokazaniya_gvs" style="display: none; height: auto; width: 488px; padding: 15px 20px 7px 20px; margin: 25px 0px 25px; background-color: #f8dae6;border: 1px solid #e7b7ca;text-align:left">
	...
	<ul><li><a href="gvs/">По горячему водоснабжению</a></li>
		<li><a href="teplo/">По отоплению</a></li></ul>
</div>

<div id="uvedoml_hes" style="display:none; height:auto; width:530px; margin:0 auto">
...
<div id="pokazaniya_gvs_ses" style="display:none; height:auto; width:530px;">
	<iframe width="530" height="298" src="https://www.youtube.com/embed/O6SiGv_DOaM?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe>
	<div style="padding:15px 20px 7px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
	<p style="font-size:16px; text-align:left"><b>Передавайте также показания:</b></p> 
	<ul><li><a href="teplo/">По отоплению</a></li>
		<li><a href="hvs/">По холодному водоснабжению (Холмск)</a></li></ul>
	</div>
</div>

<div id="pokazaniya_gvs_dal" style="display:block; height:auto; width:530px; margin:0 auto">
	<a style="display:block; height:9.5rem; padding:10px 20px; margin:25px 0px; border:1px solid #ccc; background-image: url('images/farpost.svg'); background-position:center bottom" href="https://www.vl.ru/off/o/?utm_medium=dvec_electr&utm_source=dvec_ru&utm_term=Способы передачи" target="_blank">
		Жители Владивостока - клиенты ДЭК также могут передавать показания <b>на сайте VL.RU</b></a>
	<div style="padding:10px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
		<p style="font-size:16px; text-align:left"><a href="https://www.dvec.ru/dalsbyt/private_clients/news/news.php?ID=17898"><b>Уважаемые клиенты г. Владивостока!</b><br> 
Показания индивидуальных приборов учета по ГВС необходимо подавать в ПАО «ДЭК» и «Вычислительный центр по коммунальным платежам» 
(для начислений по водоотведению). Читать далее &gt;&gt;&gt;</a></p> 
	</div>  
	<!-- <iframe width="530" height="298" src="https://www.youtube.com/embed/jAnK-Dy_4oc?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe> -->
<!--	<div style="padding:15px 20px 7px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
	<p style="font-size:16px; text-align:left"><b>Передавайте также показания:</b></p> 
	<ul><li><a href="gvs/">По горячему водоснабжению <br>(Владивосток, Артем, Партизанск, Лучегорск)</a></li>
		<li><a href="teplo/">По отоплению</a></li></ul>
	</div> 
</div>
