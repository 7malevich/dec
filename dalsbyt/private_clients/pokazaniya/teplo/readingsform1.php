...
<div id="pokazaniya_gvs_dal" style="display:block; height:auto; width:530px; margin:0 auto">
	<a style="display:block; height:9.5rem; padding:10px 20px; margin:25px 0px; border:1px solid #ccc; background-image: url('../images/farpost.svg'); background-position:center bottom" href="https://www.vl.ru/off/o/?utm_medium=dvec_teplo&utm_source=dvec_ru&utm_term=Способы передачи" target="_blank">
		Жители Владивостока также могут передавать показания <br>на сайте VL.RU
	</a>
...
<ul>
	...
	<li><a href="/private_clients/readings_reports/">Все способы передачи показаний </a></li>
</ul>
</div>
