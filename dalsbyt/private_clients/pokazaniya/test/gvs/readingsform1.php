...
<div id="pokazaniya_gvs_dal" style="display:block; height:auto; width:530px; margin:0 auto">
	<a style="display:block; height:9.5rem; padding:10px 20px; margin:25px 0px; border:1px solid #ccc; background-image: url('../images/farpost.svg'); background-position:center bottom" href="https://www.vl.ru/off/o/?utm_medium=dvec_gvs&utm_source=dvec_ru&utm_term=Способы передачи" target="_blank">
	...
	<div style="padding:10px 20px; margin:25px 0px 25px; background-color:#f8dae6;border:1px solid #e7b7ca; text-align:left">
		<p style="font-size:16px; text-align:left"><a href="https://www.dvec.ru/press_center/news_dvec/?ID=17898"><b>Уважаемые клиенты г. Владивостока!</b><br> Показания индивидуальных приборов учета по ГВС 
			необходимо подавать в ПАО «ДЭК» и «Вычислительный центр по коммунальным платежам» (для начислений по водоотведению). Читать далее &gt;&gt;&gt;</a>
</p> 
	</div> 
</div>
