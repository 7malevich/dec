...
<div class="alert alert-success mb-5 d-flex p-3 justify-content-left align-items-center" role="alert">
	<span style="padding-right: 1rem;opacity: 0.8;font-size:3rem;line-height:3rem">⚠</span>
	<span>Только для жителей Дальнегорского городского округа, получающих ЕПД (единый платежный документ) от ДЭК.</span>
</div>
